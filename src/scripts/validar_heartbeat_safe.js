/**
 * VALIDAR HEARTBEAT - Modo Seguro (apenas leitura)
 */
...
async function validarHeartbeat() {
  console.log('============================================================');
  console.log(' VALIDAÇÃO DE HEARTBEAT (MODO SEGURO)');
  console.log('============================================================\n');
  ...
  try {
    ...
    if (error) {
      if (error.code === '42P01' || error.message.includes('does not exist')) {
        ...
        console.log(`⚠️  Erro ao consultar heartbeat: ${error.message}`);
      }
    } else {
    ...
    // Salvar resultado
    const reportPath = path.join(__dirname, '..', '..', 'logs', 'heartbeat_check.json');
