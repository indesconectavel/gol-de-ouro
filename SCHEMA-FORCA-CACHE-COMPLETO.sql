-- SCHEMA FORÇA CACHE COMPLETO - GOL DE OURO v4.2
-- =====================================================
-- Data: 17/10/2025
-- Status: FORÇA ATUALIZAÇÃO COMPLETA DO CACHE SUPABASE
-- Versão: v4.2-forca-cache-completo

-- =====================================================
-- FORÇAR ATUALIZAÇÃO COMPLETA DO CACHE DO SUPABASE
-- =====================================================
...
-- 6. ATUALIZAR CACHE DO SUPABASE (MÚLTIPLAS TENTATIVAS)
NOTIFY pgrst, 'reload schema';
NOTIFY pgrst, 'reload schema';
NOTIFY pgrst, 'reload schema';

-- 7. VERIFICAR ESTRUTURA ATUAL
SELECT 'CACHE FORÇADO A ATUALIZAR COMPLETAMENTE' as status;
...
-- 10. VERIFICAR TABELA MÉTRICAS GLOBAIS
SELECT column_name, data_type, is_nullable
FROM information_schema.columns 
WHERE table_schema = 'public' 
