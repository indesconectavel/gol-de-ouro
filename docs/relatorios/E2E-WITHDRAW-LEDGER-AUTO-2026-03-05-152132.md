...
**RunId:** e2e-1772734892318  
**Timestamp:** 2026-03-05T18:21:32.388Z
...
- **Veredito:** FAIL
- **Justificativa:** Detectado erro 22P02 ou "invalid input syntax for type uuid" nos logs (1 + 1 ocorrências). Causa: correlation_id não-UUID no INSERT do ledger.
