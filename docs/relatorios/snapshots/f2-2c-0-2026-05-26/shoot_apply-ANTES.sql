-- =============================================================================
-- F2.2C.0 — Backup: public.shoot_apply ANTES da cirurgia económica V1
-- project_ref: gayopagjdrkcmkirmfvy
-- captured_at: 2026-05-26
-- Motor: random(indice_vencedor) + fecho no gol (baseline pré-F2.2C.1)
-- Nota: alinhado ao motor documentado em OC-INC-03 / rollback F2.2C.
-- =============================================================================
