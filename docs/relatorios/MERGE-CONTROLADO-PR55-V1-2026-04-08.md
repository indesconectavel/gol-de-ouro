...
**Nota de publicação:** push direto para `main` com apenas este ficheiro foi **recusado** pela branch protection (`GH006`). O relatório está em `origin/docs/mergereport-pr55-2026-04-09` para incorporação em `main` via PR: https://github.com/indesconectavel/gol-de-ouro/pull/new/docs/mergereport-pr55-2026-04-09
