...
- Pasta correta: `docs/relatorios/` — é **relatorios** (com *o*), **não** `relatori`.
- Caminho completo de exemplo (Windows): `E:\Chute de Ouro\goldeouro-backend\docs\relatorios\VALIDACAO-FINAL-BLOCO-J-PAINEL-DE-CONTROLE-2026-03-28.md`
- **Cópia espelhada** (mesmo conteúdo, nome curto): [`docs/BLOCO-J-VALIDACAO-FINAL.md`](../BLOCO-J-VALIDACAO-FINAL.md)
