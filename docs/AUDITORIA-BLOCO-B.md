...
> **Atalho de acesso:** este ficheiro é cópia do relatório formal em `docs/relatorios/AUDITORIA-READONLY-BLOCO-B-ENGINE-V1-2026-03-29.md` (mesmo conteúdo). Use **Ctrl+P** no Cursor e digite `AUDITORIA-BLOCO-B` para abrir sem depender de links do chat.
