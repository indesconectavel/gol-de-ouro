...
// Priorizar variáveis de produção
const SUPABASE_URL = process.env.SUPABASE_URL_PROD || process.env.SUPABASE_URL || 'https://gayopagjdrkcmkirmfvy.supabase.co';
const SUPABASE_SERVICE_KEY = process.env.SUPABASE_SERVICE_ROLE_KEY_PROD || process.env.SUPABASE_SERVICE_ROLE_KEY || process.env.SUPABASE_ANON_KEY;
