...
-- ============================================================================
-- Data: 2025-11-18
-- Versão: CORRIGIDA (função inexistente removida)
-- Status: Security Advisor mostra 0 erros, 22 warnings restantes
-- Objetivo: Corrigir todas as funções existentes de uma vez
-- ============================================================================

-- IMPORTANTE: Execute este script completo no Supabase SQL Editor
-- Se alguma função não existir, você receberá um erro específico - apenas ignore
...
-- NOTA: update_match_events_updated_at não existe no banco, removida
