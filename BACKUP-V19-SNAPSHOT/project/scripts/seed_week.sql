-- scripts/seed_week.sql
create extension if not exists pgcrypto;

-- Players (reforço: cria e preenche se vazio)
...
-- Seed de partidas da semana (evita duplicar)
do Out-Null
begin
...
-- Seed de palpites (espalha alguns valores para dashboard)
do Out-Null
declare
