Write-Host "=== DIAGNÓSTICO FINAL - POR QUE NÃO FUNCIONA ===" -ForegroundColor Red
Write-Host ""

Write-Host "🔍 1. VERIFICANDO VARIÁVEIS CRÍTICAS:" -ForegroundColor Cyan
flyctl secrets list

Write-Host "`n🔍 2. TESTANDO CADASTRO REAL:" -ForegroundColor Cyan
try {
  $userData = '{"name":"Teste Real","email":"teste.real@example.com","password":"senha123"}'
...
try {
  $pixData = '{"amount":5,"description":"Teste PIX Real"}'
