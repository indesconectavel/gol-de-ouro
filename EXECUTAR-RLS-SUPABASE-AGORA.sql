-- 🚨 CORREÇÃO URGENTE RLS - EXECUTAR AGORA NO SUPABASE
-- Data: 16 de Outubro de 2025 - 12:50
-- Objetivo: Corrigir 9 vulnerabilidades críticas de segurança confirmadas no print
...
-- Políticas para system_config (CRÍTICO - CONFIGURAÇÕES)
...
-- Políticas para Notification (CRÍTICO - NOTIFICAÇÕES)
...
-- Políticas para QueueEntry (CRÍTICO - FILA)
...
-- Políticas para Game (CRÍTICO - JOGOS)
...
-- Políticas para User (CRÍTICO - USUÁRIOS)
