...
// =====================================================
export const BALL = {
  // Posição inicial da bola (centro inferior do campo) — H3.5i: −60px X; H3.5l: −25px Y; H3.5p: −5px Y
  START: { x: 960, y: 980 },
  // Tamanho da bola
  SIZE: 90,
...
export const TARGETS = {
  // Posições dos círculos clicáveis (centro exato de cada zona) — H3.5i: −60px X; H3.5l: −25px Y; H3.5p: −5px Y
  TL: { x: 450, y: 490 },   // Top Left
  TR: { x: 1470, y: 490 }, // Top Right
  C: { x: 960, y: 490 },    // Center (eixo stage / goleiro idle)
  BL: { x: 450, y: 710 },   // Bottom Left
  BR: { x: 1470, y: 710 },  // Bottom Right
